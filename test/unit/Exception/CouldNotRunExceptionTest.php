...
use Dhii\Action\Exception\CouldNotRunException as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class CouldNotRunExceptionTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\Exception\CouldNotRunException';
