...
use Dhii\Action\Exception\AbstractBaseActionAwareException as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class AbstractBaseActionAwareExceptionTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\Exception\AbstractBaseActionAwareException';
    ...
    /**
     * Tests whether `getAction()` works as expected.
     *
     * @since [*next-version*]
     */
    public function testGetAction()
    {
        ...
        $subject = $this->createInstance(['_getAction']);
        ...
        $result = $subject->getAction();
        $this->assertSame($action, $result, 'Incorrect action retrieved');
    }
}
