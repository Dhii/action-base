...
use Dhii\Action\CreateRunExceptionCapableTrait as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class CreateRunExceptionCapableTraitTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\CreateRunExceptionCapableTrait';
    ...
    /**
     * Tests that `_createRunException()` works as expected.
     *
     * @since [*next-version*]
     */
    public function testCreateRunException()
    {
        ...
        $result = $_subject->_createRunException($message, $code, $previous, $action);
        try {
            throw $result;
        } catch (RootException $e) {
            $this->assertInstanceOf('Dhii\Action\Exception\RunException', $e, 'Wrong subject type');
